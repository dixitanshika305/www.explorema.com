...
// tools1.html copy to Clipboard button function
document.querySelectorAll(".copy-text").forEach(CopyTextContainer => {
    const inputField = CopyTextContainer.querySelector(".inp-tools");
    const copyButton = CopyTextContainer.querySelector(".copy-text");
